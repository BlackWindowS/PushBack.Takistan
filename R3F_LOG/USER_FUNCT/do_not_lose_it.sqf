 ...
 * 
 * The script does :
 *     It makes the object undestructible (from any kind of damage).
 *     It denies the ability to send/sell back the object to any creation factory (if applicable).
 *     If the object is loaded in a vehicle/cargo which have been destroyed, it will be unloaded/teleported to a given position.
