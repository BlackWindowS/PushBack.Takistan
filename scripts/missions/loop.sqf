...
_missions = [BwS_fn_mission_convoi, BwS_fn_mission_camp, BwS_fn_mission_attentat, BwS_fn_mission_otages/*, BwS_fn_mission_occupation, BwS_fn_mission_occupation*/] call BIS_fnc_arrayShuffle;
